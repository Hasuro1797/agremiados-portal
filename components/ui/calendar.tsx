  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary text-white hover:bg-blue-500 hover:text-slate-900 focus:bg-primary focus:text-white dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "bg-primary text-white dark:bg-slate-800 dark:text-white",
        day_outside:
